...
-- 1) 데이터 저장
insert into book values ('2022004', '자바입문1', '홍길동', '한빛출판사', 20000);
insert into book values ('2022005', '파이썬입문1', '고길동', '샛별출판사', 30000);
insert into book values ('2022006', 'JSP입문1', '이영희', '한빛출판사', 10000);
